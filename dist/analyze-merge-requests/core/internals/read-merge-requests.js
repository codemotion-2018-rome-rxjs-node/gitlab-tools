...
function readMergeRequestsForGroup(gitLabUrl, token, groupId) {
    ...
    return (0, rxjs_1.from)(query).pipe((0, rxjs_1.map)(resp => {
        ...
        return (0, rxjs_1.from)(nextListMergeRequestsCommand(gitLabUrl, token, groupId, page)).pipe((0, rxjs_1.map)(resp => {
            const mergeRequestsPaged = resp.data;
            mergeRequests.push(...mergeRequestsPaged);
            return { mergeRequests, _nextPage };
        }));
...
function nextListMergeRequestsCommand(gitLabUrl, token, groupId, page) {
