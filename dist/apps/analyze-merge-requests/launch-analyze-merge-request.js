...
const launch_analyze_merge_requests_1 = require("./internals/launch-analyze-merge-requests");
function launchMergeRequestAnalysis() {
    ...
    (0, launch_analyze_merge_requests_1.launchAnalyzeMergRequestInternal)(gitLabUrl, token, groupId, outdir).subscribe();
}
...
//# sourceMappingURL=launch-analyze-merge-request.js.map